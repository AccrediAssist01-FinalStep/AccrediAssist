...
import { searchListQuerySchema, searchExecuteSchema, globalSearchRequestSchema, searchHistoryListQuerySchema } from '../validations/search.validation';
...
searchRouter.post('/', validate(globalSearchRequestSchema), searchController.globalSearch);
